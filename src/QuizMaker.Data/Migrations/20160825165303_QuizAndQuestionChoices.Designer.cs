...
namespace QuizMaker.Data.Migrations
{
    ...
    [Migration("20160825165303_QuizAndQuestionChoices")]
    partial class QuizAndQuestionChoices
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("QuizMaker.Models.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("QuizMaker.Models.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("QuizMaker.Models.QuestionChoice", b =>
                {
            ...
            modelBuilder.Entity("QuizMaker.Models.QuizCategory", b =>
                {
            ...
            modelBuilder.Entity("QuizMaker.Models.QuizChoice", b =>
                {
            ...
            modelBuilder.Entity("QuizMaker.Models.QuizGroup", b =>
                {
                    b.Property<Guid>("QuizGroupId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("QuizMaker.Models.QuizPrerequisites", b =>
                {
                    b.Property<Guid>("QuizId");
            ...
            modelBuilder.Entity("QuizMaker.Models.QuizSession", b =>
                {
                    b.Property<Guid>("QuizId");
            ...
            modelBuilder.Entity("QuizMaker.Models.Session", b =>
                {
                    b.Property<Guid>("SessionId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("QuizMaker.Models.SessionAnswer", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("QuizMaker.Models.ApplicationRole")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("QuizMaker.Models.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("QuizMaker.Models.Quiz", b =>
                {
                    b.HasOne("QuizMaker.Models.QuizGroup", "QuizGroup")
                        .WithMany("Quizes")
            ...
            modelBuilder.Entity("QuizMaker.Models.QuizGroup", b =>
                {
                    b.HasOne("QuizMaker.Models.QuizCategory", "QuizCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("QuizMaker.Models.QuizPrerequisites", b =>
                {
                    b.HasOne("QuizMaker.Models.Quiz")
            ...
            modelBuilder.Entity("QuizMaker.Models.QuizSession", b =>
                {
                    ...
                    b.HasOne("QuizMaker.Models.Session", "Session")
                        .WithMany("QuizSessions")
            ...
            modelBuilder.Entity("QuizMaker.Models.Session", b =>
                {
                    b.HasOne("QuizMaker.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
