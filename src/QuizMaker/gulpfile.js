...
var Config = (function () {
    ...
    return {
        nodePackagePaths: ["@angular", "bootstrap/dist", "core-js", "jquery", "jquery-validation", "jquery-validation-unobtrusive", "reflect-metadata", "rxjs", "systemjs/dist", "zone.js/dist"],
        paths: this.paths
    };
})();
